...
class _SearchMovieScreenState extends State<SearchMovieScreen> {
  ...
  final String apiKey = 'df23d7f72a3dce5a4d496283b8133f48';

  Future<List<dynamic>> fetchMovies(String query) async {
    final url = Uri.parse("$baseUrl/search/movie?api_key=$apiKey&language=pt-BR&query=$query");
          ...
          children: [
            ...
            Expanded(
              child: _searchResults == null
                  ? const Center(child: Text('Digite um título para buscar.'))
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final movie = Movie(
                                ...
                                overview: movieData['overview'] ?? 'Sem descrição',
                                posterPath: movieData['poster_path'] ?? '',
                                releaseDate: movieData['release_date'] ?? 'Sem data',
